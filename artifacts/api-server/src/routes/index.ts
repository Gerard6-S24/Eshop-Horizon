...
router.get("/seed-products", async (req, res) => { 
  try {
    ...
    // Insertion des produits avec leurs images respectives
    await db.insert(productsTable).values([ 
      { 
        ...
        isTrending: true, 
        badge: "Viral TikTok", 
        imageUrl: "https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg?w=500", 
      ...
      { 
        ...
        isTrending: true, 
        badge: null, 
        imageUrl: "https://images.pexels.com/photos/6816866/pexels-photo-6816866.jpeg?w=500", 
    ...
    res.json({ success: true, message: "✅ 3 produits insérés avec leurs images !" }); 
  } catch (error) {
    console.error(error);
    res.status(500).json({ success: false, message: "Erreur lors du seed des produits." });
  }
});
